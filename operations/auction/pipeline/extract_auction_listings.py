...
Usage:
  python extract_auction_listings.py                          # all sites, all make/models
  python extract_auction_listings.py --site Zervtek            # one site only
  python extract_auction_listings.py --maker TOYOTA            # one maker only
  python extract_auction_listings.py --limit 5                 # first 5 make/model jobs (test run)
  python extract_auction_listings.py --dry-run                 # extract only (no JSON save)
"""
